...
type PracticeSettingCodeValueSetType = {
    version: '5.0.0',
    compose: {
        include: [
            {
 ...
 * 
 *  Source: http://hl7.org/fhir/ValueSet/c80-practice-codes.
 */
type PracticeSettingCodeValueSet = Override<ValueSet, PracticeSettingCodeValueSetType>;
